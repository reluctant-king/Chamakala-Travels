...
const Destinations = () => {
  return (
    <>
      <Seo title="Popular Travel Destinations" description="Explore handpicked travel destinations from Kottayam, Kerala. Chamakkala Travels offers curated packages to India, Gulf, and worldwide destinations." path="/destinations" />
