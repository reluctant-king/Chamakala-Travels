...
const About = () => {
  return (
    <>
      <Seo title="About Us – Travel Agency in Kottayam, Kerala" description="Chamakkala Travels is a trusted travel agency in Neendoor, Kottayam. Book flights, trains, buses and curated tour packages with Kerala's local travel experts." path="/about" />
