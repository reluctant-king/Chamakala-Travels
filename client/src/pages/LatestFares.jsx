...
const LatestFares = () => {
  return (
    <>
      <Seo title="Latest Fares – Flights, Trains & Buses" description="Browse live flight, train and bus fares from Kottayam, Kerala. Find the best deals and book your next trip with Chamakkala Travels." path="/fares" />
